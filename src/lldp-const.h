...
/* DCBX bits */
#define LLDP_DCBX_PFC_WILLING	0x80
#define LLDP_DCBX_PFC_MBC	0x40
#define LLDP_DCBX_PFC_CAP	0x3f

#define LLDP_DCBX_APP_PRI	0xe0
#define LLDP_DCBX_APP_PRI_SHIFT	5
#define LLDP_DCBX_APP_SEL	0x07
#define LLDP_DCBX_APP_PROTO	0xffff
